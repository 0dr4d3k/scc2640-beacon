...
build-447888065:
	@$(MAKE) --no-print-directory -Onone -f TOOLS/subdir_rules.mk build-447888065-inproc

build-447888065-inproc: C:/ti/simplelink/ble_sdk_2_02_02_25/examples/cc2650lp/simple_broadcaster/ccs/config/app_ble.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-447888065 C:/ti/simplelink/ble_sdk_2_02_02_25/examples/cc2650lp/simple_broadcaster/ccs/config/app_ble.cfg
configPkg/compiler.opt: build-447888065
configPkg/: build-447888065
